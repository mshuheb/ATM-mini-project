...
public:                              //public member functions
	...
	void setMobile(string mob_prev, string mob_new)
	{
		if (mob_prev == mobile_No)           //it will check old Mobile no
		{
			...
			cout << endl << "Sucessfully Updates Mobile no.";
...
int main()
{
	...
	system("cls");           //Used to clear the screen whenever we move from one menu to another
		...
		if ((enterAccountNo == user1.getAccountNo()) && (enterPIN == user1.getPIN()))
		{
			do
			{
				...
				case 3:                       //if user presses 3
					...
					cout << endl << "->Mobile No." << user1.getMobileNo();   //getting and printing user details
				...
				case 4:                   //if user presses 4
					...
					user1.setMobile(oldMobileNo, newMobileNo);   //now set mobile no
					break;
